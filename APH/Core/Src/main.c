...
uint32_t normalTaskBuffer[ 1024 ];
...
osEventFlagsId_t normTaskEventHandle;
osStaticEventGroupDef_t normTaskEventControlBlock;
const osEventFlagsAttr_t normTaskEvent_attributes = {
  .name = "normTaskEvent",
  .cb_mem = &normTaskEventControlBlock,
  .cb_size = sizeof(normTaskEventControlBlock),
};
/* Definitions for slowTaskEvent */
osEventFlagsId_t slowTaskEventHandle;
osStaticEventGroupDef_t slowTaskEventControlBlock;
const osEventFlagsAttr_t slowTaskEvent_attributes = {
  .name = "slowTaskEvent",
  .cb_mem = &slowTaskEventControlBlock,
  .cb_size = sizeof(slowTaskEventControlBlock),
};
/* USER CODE BEGIN PV */
